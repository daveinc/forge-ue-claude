...
5. Run GSD's `extract-learnings.md` after an accepted phase or resolved incident, then shape its result into atomic learning records using [promotion.md](../skills/forge-retrospective/references/promotion.md). Own the forensic pass natively; run only the extraction through GSD.
