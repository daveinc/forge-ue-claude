...
description: Plan a phase as a vertical slice — the thinnest playable thing — and split it when it is too big. Use when a phase is large or vague, or before committing to production on an unproven mechanic.
---

# Forge MVP Phase

Delegation mode: **relay** — surface each question in game-dev framing and pass answers back down. Never black-box it. GSD workflow: `mvp-phase.md`.
