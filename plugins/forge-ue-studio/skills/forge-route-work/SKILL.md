...
description: Compile, rank, and dispatch bounded work across qualified local and remote models, Unreal routes, Blender, research, build, and QA lanes. Use when parallelising departments, offloading context-heavy tasks, or recovering attempts.
---
...
6. Apply hard filters and rank offload routes using [routing.md](references/routing.md). Prefer a qualified free, local, or already-installed worker when resident-context, time, or lane savings exceed handoff and verification cost.
