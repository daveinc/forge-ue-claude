...
9. Resolve the work order through `.forge/state/packet-registry.json`. Reject unregistered IDs. Preserve the canonical ID; aliases are display/input compatibility only and derived packets must name their parents.
