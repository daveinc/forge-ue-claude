...
|---:|---|---|---|
| 1 | `FI-HOST` | Host, hardware, permissions, resident-host and GSD inventory | researcher/explorer |
...
| 2 | `FI-PROVIDER` | Per-task provider evaluation against the resident-host baseline | capability manager |
