...
description: Run a bounded adversarial improvement loop against a named reference or feel rubric using playable builds, variants, harsh critique, and blind comparison. Use for combat feel, traversal, readability, or encounter pacing once a loop exists.
---
