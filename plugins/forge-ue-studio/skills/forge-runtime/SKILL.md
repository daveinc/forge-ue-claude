---
name: forge-runtime
description: Inspect, assign, or swap the resident AI runtime host for a project without losing state. Use when choosing which AI CLI runs a project, moving between hosts, adding a host, or re-rendering stale surfaces.
---
